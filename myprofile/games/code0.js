...
gdjs.OverworldCode.asyncCallback16931404 = function (runtimeScene, asyncObjectsList) {
...
gdjs.OverworldCode.idToCallbackMap.set(16931404, gdjs.OverworldCode.asyncCallback16931404);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.25), (runtimeScene) => (gdjs.OverworldCode.asyncCallback16931404(runtimeScene, asyncObjectsList)), 16931404, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16928916);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
